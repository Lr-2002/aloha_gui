...
class RosOperator:
    ...
    def process(self):
        ...
        try:
            ...
            print("\nStop requested. Saving partial episode.")
...
def get_arguments():
    ...
    parser.add_argument('--img_front_depth_topic', action='store', type=str, help='img_front_depth_topic',
                        default='/camera_f/aligned_depth_to_color/image_raw', required=False)
    parser.add_argument('--img_left_depth_topic', action='store', type=str, help='img_left_depth_topic',
                        default='/camera_l/aligned_depth_to_color/image_raw', required=False)
    parser.add_argument('--img_right_depth_topic', action='store', type=str, help='img_right_depth_topic',
                        default='/camera_r/aligned_depth_to_color/image_raw', required=False)
...
def main():
    ...
    if len(actions) == 0:
        print("\033[31m\nSave failure, no actions collected.\033[0m\n")
        exit(-1)
